...
Inicie o docker-compose na pasta em que se encontra o docker-compose.yml `docker-compose up -d`
...
<li> Sessão calendário que permite a visualização das datas em que as pipelines foram executadas e possíveis erros em execuções. Possibilita também que o usuário veja as futuras runs planejadas
